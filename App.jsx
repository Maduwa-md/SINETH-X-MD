...
function App() {
  ...
  const ownerLink = "https://wa.me/+94781629812?text=*Hey_SINETH-MD_owner 👋*";
...
<div className="menu-btn" onClick={toggleMenu}>☰</div>
  ...
  <div className="bot-text">
    <h1>WELCOME TO SINETH-X-MD V.1 MINI BOT</h1>
     <p>SINETH-X-MD Mini BOT makes your WhatsApp experience easier, faster, and more automated.</p>
   </div> 
 ...
 <div className="about-me" id="about">
    ...
    <p>SINETH-X-MD is built with a strong focus on speed, stability, and customization, making it easy to deploy and customize for personal or public use. It supports multi-device WhatsApp connections and can be deployed on platforms like Heroku, Render, Railway, and others.</p>
    <br></br>
   </div>
 </div>
 
<div className="footer">
  <p>&copy; 2026 POWERED BY SINETH-X-MD MINI BOT</p>
</div>
  </>)
  }
